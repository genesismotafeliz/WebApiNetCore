namespace WebApiNetCore.Controllers
{
    ...
    public class AlbumsController : ControllerBase
    {
        ...
        // GET:  it will get a list of all albums 
        [HttpGet]
        ...
        // GET: it will get an album given it an ID
        [HttpGet("{id}")]
        ...
        // PUT: it will update an album or a list (I gues)
        [HttpPut("{id}")]
